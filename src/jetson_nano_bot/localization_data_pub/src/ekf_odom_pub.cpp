...
/*
*
* REMEMBER THAT WE NEED TO CHANGE THESE:
*
*/


// Robot physical constants
const double TICKS_PER_REVOLUTION = 30; // For reference purposes.
const double WHEEL_RADIUS = 0.177; // Wheel radius in meters
const double WHEEL_BASE = 0.584; // Center of left tire to center of right tire
const int WHEEL_CIRCUMFERENCE = (WHEEL_RADIUS * 3.14159 * 2); 
const int WHEEL_ROTATION_PER_METER = (1 / 3.14159 / 2) / WHEEL_CIRCUMFERENCE; 
const double TICKS_PER_METER = WHEEL_ROTATION_PER_METER * TICKS_PER_REVOLUTION; 
